...
public final class DefinesMessages {
    ...
    public enum TypeMessage {
        EntryRequest(0), EntryReply(1), RegistrationRequest(2), RegistrationReply(
                3), VerifyRegistrationEmailRequest(4), VerifyRegistrationEmailReply(
                        5), ResetPasswordRequest(6), ResetPasswordReply(
                                7), VerifyFamousEmailRequest(8), VerifyFamousEmailReply(
                                        9), ChangePasswordRequest(10), ChangePasswordReply(
                                                11), ChatsLoadRequest(12), ChatsLoadReply(
                                                        13), CheckOnlineUserRequest(
                                                                14), CheckOnlineUserReply(
                                                                        15), LoadUsersOnlineStatusRequest(
                                                                                16), LoadUsersOnlineStatusReply(
