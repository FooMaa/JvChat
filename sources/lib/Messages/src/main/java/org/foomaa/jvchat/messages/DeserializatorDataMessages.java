...
public class DeserializatorDataMessages {
        ...
        try {
            result.put(
                    ...
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            ...
                            .getLogin());
            result.put(
                    DefinesMessages.TypeData.Password,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getEntryRequest()
                            .getPassword());
        } catch (InvalidProtocolBufferException exception) {
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeEntryReplyMessage(byte[] data) {
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getEntryReply()
                            .getReply());
            result.put(
                    DefinesMessages.TypeData.UuidUser,
        ...
        try {
            result.put(
                    ...
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            ...
                            .getReply());
            result.put(
                    DefinesMessages.TypeData.ErrorReg,
    ...
    private HashMap<DefinesMessages.TypeData, String> takeVerifyRegistrationEmailRequestMessage(byte[] data) {
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.Login,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getVerifyRegistrationEmailRequest()
                            .getLogin());
            result.put(
                    DefinesMessages.TypeData.Email,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
            ...
            result.put(
                    ...
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            ...
                            .getPassword());
            result.put(
                    DefinesMessages.TypeData.VerifyCode,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getVerifyRegistrationEmailRequest()
                            .getCode());
        } catch (InvalidProtocolBufferException exception) {
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeVerifyRegistrationEmailReplyMessage(byte[] data) {
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getVerifyRegistrationEmailReply()
                            .getReply());
            result.put(
                    DefinesMessages.TypeData.ErrorReg,
                    DefinesMessages.TypeErrorRegistration.getTypeError(
    ...
    private HashMap<DefinesMessages.TypeData, List<Map<DefinesMessages.TypeData, Object>>> takeChatsLoadReplyMessage(
        ...
        try {
            ...
            for (int i = 0; i < chatsLoadReplyMsg.getChatsInfoCount(); i++) {
                ...
                UUID uuidUser =
                        UUID.fromString(chatsLoadReplyMsg.getChatsInfo(i).getUuidUser());
                String lastMessageText = chatsLoadReplyMsg.getChatsInfo(i).getLastMessageText();
                UUID uuidChat =
                        UUID.fromString(chatsLoadReplyMsg.getChatsInfo(i).getUuidChat());
                UUID uuidMessage =
                        UUID.fromString(chatsLoadReplyMsg.getChatsInfo(i).getUuidMessage());
                Boolean isLoginSentLastMessage =
                        chatsLoadReplyMsg.getChatsInfo(i).getIsLoginSentLastMessage();
                MainChatsGlobalDefines.TypeStatusMessage statusMessage =
                        MainChatsGlobalDefines.TypeStatusMessage.getTypeStatusMessage(chatsLoadReplyMsg
                                .getChatsInfo(i)
                                .getStatusMessage()
                                .getNumber());
    ...
    private HashMap<DefinesMessages.TypeData, String> takeCheckOnlineUserRequestMessage(byte[] data) {
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.IP,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getCheckOnlineRequest()
                            .getIp());
        } catch (InvalidProtocolBufferException exception) {
            log.error("Error in protobuf deserialised data.");
        }
    ...
    private HashMap<DefinesMessages.TypeData, List<UUID>> takeLoadUsersOnlineStatusRequestMessage(byte[] data) {
        ...
        try {
            ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusRequest loadUsersOnlineStatusRequestMsg =
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getLoadUsersOnlineStatusRequest();
    ...
    private HashMap<DefinesMessages.TypeData, Map<UUID, ?>> takeLoadUsersOnlineStatusReplyMessage(byte[] data) {
        ...
        try {
            ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply loadUsersOnlineStatusReply =
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getLoadUsersOnlineStatusReply();

            Map<String, ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply.StatusOnline>
                    mapStatusesUsers = loadUsersOnlineStatusReply.getMapStatusOnlineMap();
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeTextMessageSendUserToServerVerificationMessage(byte[] data) {
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getTextMessageSendUserToServerVerification()
                            .getReply());
        } catch (InvalidProtocolBufferException exception) {
            log.error("Error in protobuf deserialised data.");
        }
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeTextMessagesChangingStatusFromServerMessage(byte[] data) {
        ...
        try {
            ...
            Map<String, ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServer.StatusMessage>
                    mapStatusesMessages = msgData.getMapStatusMessagesMap();
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeTextMessagesChangingStatusFromServerVerificationMessage(
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getTextMessagesChangingStatusFromServerVerification()
                            .getReply());
        } catch (InvalidProtocolBufferException exception) {
            log.error("Error in protobuf deserialised data.");
        }
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeTextMessagesChangingStatusFromUserVerificationMessage(
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getTextMessagesChangingStatusFromUserVerification()
                            .getReply());
        } catch (InvalidProtocolBufferException exception) {
            log.error("Error in protobuf deserialised data.");
        }
    ...
    private HashMap<DefinesMessages.TypeData, Object> takeTextMessageRedirectServerToUserVerificationMessage(
        ...
        try {
            result.put(
                    DefinesMessages.TypeData.BoolReply,
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getTextMessageRedirectServerToUserVerification()
                            .getReply());
        } catch (InvalidProtocolBufferException exception) {
            log.error("Error in protobuf deserialised data.");
        }
    ...
    private HashMap<DefinesMessages.TypeData, List<Map<DefinesMessages.TypeData, Object>>> takeMessagesLoadReplyMessage(
        ...
        try {
            ClientServerSerializeProtocolMessage_pb.MessagesLoadReply msgLoadReplyMsg =
                    ClientServerSerializeProtocolMessage_pb.General.parseFrom(data)
                            .getMessagesLoadReply();

            List<Map<DefinesMessages.TypeData, Object>> listMainData = new ArrayList<>();
            for (int i = 0; i < msgLoadReplyMsg.getTextMessageInfoCount(); i++) {
                UUID uuidUserSender =
                        UUID.fromString(msgLoadReplyMsg.getTextMessageInfo(i).getUuidUserSender());
                UUID uuidUserReceiver =
                        UUID.fromString(msgLoadReplyMsg.getTextMessageInfo(i).getUuidUserReceiver());
                UUID uuidMessage =
                        UUID.fromString(msgLoadReplyMsg.getTextMessageInfo(i).getUuidMessage());
