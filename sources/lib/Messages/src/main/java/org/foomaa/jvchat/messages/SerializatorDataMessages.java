...
public class SerializatorDataMessages {
        ...
        switch (type) {
            ...
            case MessagesLoadReply -> {
                if (parameters.length == 1) {
                    ...
                    List<Map<DbGlobalDefines.LineKeys, String>> messagesInfo = structTools.objectInListMaps(
                            messagesInfoObj, DbGlobalDefines.LineKeys.class, String.class);
    ...
    private byte[] createEntryRequestMessage(DefinesMessages.TypeMessage type, String login, String password) {
        ClientServerSerializeProtocolMessage_pb.EntryRequest msgEntryRequest = ClientServerSerializeProtocolMessage_pb.EntryRequest.newBuilder().setLogin(
                login).setPassword(password).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setEntryRequest(msgEntryRequest).build();
    ...
    private byte[] createEntryReplyMessage(DefinesMessages.TypeMessage type, boolean reply, UUID uuidUser) {
        ClientServerSerializeProtocolMessage_pb.EntryReply msgEntryReply = ClientServerSerializeProtocolMessage_pb.EntryReply.newBuilder().setReply(
                reply).setUuidUser(uuidUser.toString()).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setEntryReply(msgEntryReply).build();
        return resMsg.toByteArray();
    }

    private byte[] createRegistrationRequestMessage(DefinesMessages.TypeMessage type, String login, String email,
            String password) {
        ClientServerSerializeProtocolMessage_pb.RegistrationRequest msgRegRequest = ClientServerSerializeProtocolMessage_pb.RegistrationRequest.newBuilder().setLogin(
                login).setEmail(email).setPassword(password).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setRegistrationRequest(msgRegRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createRegistrationReplyMessage(DefinesMessages.TypeMessage type, boolean reply,
            DefinesMessages.TypeErrorRegistration error) {
        ClientServerSerializeProtocolMessage_pb.RegistrationReply msgRegReply = ClientServerSerializeProtocolMessage_pb.RegistrationReply.newBuilder().setReply(
                reply).setError(ClientServerSerializeProtocolMessage_pb.RegistrationReply.Error.forNumber(
                        error.getValue())).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setRegistrationReply(msgRegReply).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createVerifyRegistrationEmailRequestMessage(DefinesMessages.TypeMessage type, String login,
        ...
        ClientServerSerializeProtocolMessage_pb.VerifyRegistrationEmailRequest msgVerifyRegRequest = ClientServerSerializeProtocolMessage_pb.VerifyRegistrationEmailRequest.newBuilder().setLogin(
                login).setEmail(email).setPassword(password).setCode(code).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setVerifyRegistrationEmailRequest(msgVerifyRegRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createVerifyRegistrationEmailReplyMessage(DefinesMessages.TypeMessage type, boolean reply,
            DefinesMessages.TypeErrorRegistration error) {
        ClientServerSerializeProtocolMessage_pb.VerifyRegistrationEmailReply msgVerifyRegReply = ClientServerSerializeProtocolMessage_pb.VerifyRegistrationEmailReply.newBuilder().setReply(
                reply).setError(ClientServerSerializeProtocolMessage_pb.VerifyRegistrationEmailReply.Error.forNumber(
                        error.getValue())).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setVerifyRegistrationEmailReply(msgVerifyRegReply).build();
        return resMsg.toByteArray();
    }

    private byte[] createResetPasswordRequestMessage(DefinesMessages.TypeMessage type, String email) {
        ClientServerSerializeProtocolMessage_pb.ResetPasswordRequest msgResetRequest = ClientServerSerializeProtocolMessage_pb.ResetPasswordRequest.newBuilder().setEmail(
                email).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setResetPasswordRequest(msgResetRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createResetPasswordReplyMessage(DefinesMessages.TypeMessage type, boolean reply) {
        ClientServerSerializeProtocolMessage_pb.ResetPasswordReply msgResetReply = ClientServerSerializeProtocolMessage_pb.ResetPasswordReply.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setResetPasswordReply(msgResetReply).build();
        return resMsg.toByteArray();
    }

    private byte[] createVerifyFamousEmailRequestMessage(DefinesMessages.TypeMessage type, String email, String code) {
        ClientServerSerializeProtocolMessage_pb.VerifyFamousEmailRequest msgVerifyEmailRequest = ClientServerSerializeProtocolMessage_pb.VerifyFamousEmailRequest.newBuilder().setEmail(
                email).setCode(code).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setVerifyFamousEmailRequest(msgVerifyEmailRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createVerifyFamousEmailReplyMessage(DefinesMessages.TypeMessage type, boolean reply) {
        ClientServerSerializeProtocolMessage_pb.VerifyFamousEmailReply msgVerifyEmailReply = ClientServerSerializeProtocolMessage_pb.VerifyFamousEmailReply.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setVerifyFamousEmailReply(msgVerifyEmailReply).build();
        return resMsg.toByteArray();
    }

    private byte[] createChangePasswordRequestMessage(DefinesMessages.TypeMessage type, String email, String password) {
        ClientServerSerializeProtocolMessage_pb.ChangePasswordRequest msgChangePasswordRequest = ClientServerSerializeProtocolMessage_pb.ChangePasswordRequest.newBuilder().setEmail(
                email).setPassword(password).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setChangePasswordRequest(msgChangePasswordRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createChangePasswordReplyMessage(DefinesMessages.TypeMessage type, boolean reply) {
        ClientServerSerializeProtocolMessage_pb.ChangePasswordReply msgChangePasswordReply = ClientServerSerializeProtocolMessage_pb.ChangePasswordReply.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setChangePasswordReply(msgChangePasswordReply).build();
        return resMsg.toByteArray();
    }

    private byte[] createChatsLoadRequestMessage(DefinesMessages.TypeMessage type, UUID uuidUser) {
        ClientServerSerializeProtocolMessage_pb.ChatsLoadRequest msgChatsLoadRequest = ClientServerSerializeProtocolMessage_pb.ChatsLoadRequest.newBuilder().setUuidUser(
                uuidUser.toString()).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setChatsLoadRequest(msgChatsLoadRequest).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createChatsLoadReplyMessage(DefinesMessages.TypeMessage type,
        ...
        ClientServerSerializeProtocolMessage_pb.ChatsLoadReply.Builder builder = ClientServerSerializeProtocolMessage_pb.ChatsLoadReply.newBuilder();

        for (Map<DbGlobalDefines.LineKeys, String> map : chatsInfo) {
            ClientServerSerializeProtocolMessage_pb.ChatsInfo chatsInfoPart = ClientServerSerializeProtocolMessage_pb.ChatsInfo.newBuilder().setLogin(
                    map.get(DbGlobalDefines.LineKeys.Login)).setLastMessageText(map.get(
                            DbGlobalDefines.LineKeys.TextMessage)).setUuidChat(map.get(
                                    DbGlobalDefines.LineKeys.UuidChat)).setUuidUser(map.get(
                                            DbGlobalDefines.LineKeys.UuidUser)).setUuidMessage(map.get(
                                                    DbGlobalDefines.LineKeys.UuidMessage)).setIsLoginSentLastMessage(
        ...
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setChatsLoadReply(msgChatsLoadReply).build();

        return resMsg.toByteArray();
    }

    private byte[] createCheckOnlineUserRequestMessage(DefinesMessages.TypeMessage type, String ip) {
        ClientServerSerializeProtocolMessage_pb.CheckOnlineUserRequest msgCheckOnlineRequest = ClientServerSerializeProtocolMessage_pb.CheckOnlineUserRequest.newBuilder().setIp(
                ip).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setCheckOnlineRequest(msgCheckOnlineRequest).build();
        return resMsg.toByteArray();
    }

    private byte[] createCheckOnlineUserReplyMessage(DefinesMessages.TypeMessage type, UUID uuidUser) {
        ClientServerSerializeProtocolMessage_pb.CheckOnlineUserReply msgCheckOnlineReplyBuilder = ClientServerSerializeProtocolMessage_pb.CheckOnlineUserReply.newBuilder().setUuidUser(
                uuidUser.toString()).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setCheckOnlineReply(msgCheckOnlineReplyBuilder).build();
        return resMsg.toByteArray();
    }

    private byte[] createLoadUsersOnlineStatusRequestMessage(DefinesMessages.TypeMessage type, List<UUID> uuidsUsers) {
        ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusRequest.Builder builder = ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusRequest.newBuilder();
        ...
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setLoadUsersOnlineStatusRequest(msgLoadUsersOnlineStatusRequest).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createLoadUsersOnlineStatusReplyMessage(DefinesMessages.TypeMessage type,
        ...
        for (UUID key : statusesUsers.keySet()) {
            ...
            ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply.StatusOnline statusMsg = ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply.StatusOnline.forNumber(
                    integerStatus);
        ...
        ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply msgLoadUsersOnlineStatusReply = ClientServerSerializeProtocolMessage_pb.LoadUsersOnlineStatusReply.newBuilder().putAllMapStatusOnline(
                newMapStatusesUsers).putAllMapLastOnlineTime(newMapLastOnlineTimes).build();

        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setLoadUsersOnlineStatusReply(msgLoadUsersOnlineStatusReply).build();
    ...
    private byte[] createTextMessageSendUserToServerMessage(DefinesMessages.TypeMessage type, UUID uuidUserSender,
            UUID uuidUserReceiver, UUID uuidMessage, String text, String timestamp) {
        ClientServerSerializeProtocolMessage_pb.TextMessageInfo messageInfo = ClientServerSerializeProtocolMessage_pb.TextMessageInfo.newBuilder().setUuidUserSender(
                uuidUserSender.toString()).setUuidUserReceiver(uuidUserReceiver.toString()).setUuidMessage(
                        uuidMessage.toString()).setText(text).setTimestamp(timestamp).build();
        ClientServerSerializeProtocolMessage_pb.TextMessageSendUserToServer msgTextMessageSendUserToServer = ClientServerSerializeProtocolMessage_pb.TextMessageSendUserToServer.newBuilder().setTextMessageInfo(
                messageInfo).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessageSendUserToServer(msgTextMessageSendUserToServer).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessageSendUserToServerVerificationMessage(
        ...
        ClientServerSerializeProtocolMessage_pb.TextMessageSendUserToServerVerification msgVerify = ClientServerSerializeProtocolMessage_pb.TextMessageSendUserToServerVerification.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessageSendUserToServerVerification(msgVerify).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessageChangingStatusFromServerMessage(
        ...
        for (UUID uuid : mapStatusMessages.keySet()) {
            ...
            ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServer.StatusMessage statusMsg = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServer.StatusMessage.forNumber(
                    statusInt);
            resultMap.put(uuid.toString(), statusMsg);
        }

        ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServer msgTextMessagesChangingStatusFromServer = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServer.newBuilder().putAllMapStatusMessages(
                resultMap).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessagesChangingStatusFromServer(
                        msgTextMessagesChangingStatusFromServer).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessagesChangingStatusFromServerVerificationMessage(
        ...
        ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServerVerification msgVerify = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromServerVerification.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessagesChangingStatusFromServerVerification(msgVerify).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessageChangingStatusFromUserMessage(DefinesMessages.TypeMessage type,
        ...
        for (UUID uuid : mapStatusMessages.keySet()) {
            int statusInt = mapStatusMessages.get(uuid).getValue();
            ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUser.StatusMessage statusMsg = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUser.StatusMessage.forNumber(
                    statusInt);
            resultMap.put(uuid.toString(), statusMsg);
        }

        ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUser msgTextMessagesChangingStatusFromUser = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUser.newBuilder().putAllMapStatusMessages(
                resultMap).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessagesChangingStatusFromUser(msgTextMessagesChangingStatusFromUser).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessagesChangingStatusFromUserVerificationMessage(
        ...
        ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUserVerification msgVerify = ClientServerSerializeProtocolMessage_pb.TextMessagesChangingStatusFromUserVerification.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessagesChangingStatusFromUserVerification(msgVerify).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createTextMessageRedirectServerToUserVerificationMessage(
        ...
        ClientServerSerializeProtocolMessage_pb.TextMessageRedirectServerToUserVerification msgVerify = ClientServerSerializeProtocolMessage_pb.TextMessageRedirectServerToUserVerification.newBuilder().setReply(
                reply).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setTextMessageRedirectServerToUserVerification(msgVerify).build();
        return resMsg.toByteArray();
    }

    private byte[] createMessagesLoadRequestMessage(DefinesMessages.TypeMessage type, UUID uuidChat,
            int quantityMessages) {
        ClientServerSerializeProtocolMessage_pb.MessagesLoadRequest loadMessagesRequest = ClientServerSerializeProtocolMessage_pb.MessagesLoadRequest.newBuilder().setUuidChat(
                uuidChat.toString()).setQuantityMessages(quantityMessages).build();
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setMessagesLoadRequest(loadMessagesRequest).build();
        return resMsg.toByteArray();
    }
    ...
    private byte[] createMessagesLoadReplyMessage(DefinesMessages.TypeMessage type,
        ...
        ClientServerSerializeProtocolMessage_pb.MessagesLoadReply.Builder builder = ClientServerSerializeProtocolMessage_pb.MessagesLoadReply.newBuilder();
        ...
        ClientServerSerializeProtocolMessage_pb.General resMsg = ClientServerSerializeProtocolMessage_pb.General.newBuilder().setType(
                type.getValue()).setMessagesLoadReply(msgMessagesLoadReply).build();
