...
public class ModelsConfig {
    @Bean
    @Lazy
    public ChatsModel beanChatsModel(UsersInfoSettings usersInfoSettings, UsersModel usersModel,
        ...
        return ChatsModel.builder().usersInfoSettings(usersInfoSettings).usersModel(
                usersModel).messageStructObjectFactory(messageStructObjectFactory).chatStructObjectFactory(
                        chatStructObjectFactory).userStructObjectFactory(
                                userStructObjectFactory).rootStructObjectFactory(
    ...
    @Lazy
    @Profile("servers")
    public CheckersOnlineModel beanCheckersOnlineModel(UsersModel usersModel,
        ...
        return CheckersOnlineModel.builder().usersModel(usersModel).socketRunnableCtrlModel(
                socketRunnableCtrlModel).checkerOnlineStructObjectFactory(
                        checkerOnlineStructObjectFactory).rootStructObjectFactory(
                                rootStructObjectFactory).rootObjectsModel(rootObjectsModel).build();
    }
    ...
    @Bean
    @Lazy
    public MessagesModel beanMessagesModel(MessageStructObjectFactory messageStructObjectFactory,
            RootStructObjectFactory rootStructObjectFactory, RootObjectsModel rootObjectsModel) {
        return MessagesModel.builder().messageStructObjectFactory(messageStructObjectFactory).rootStructObjectFactory(
                rootStructObjectFactory).rootObjectsModel(rootObjectsModel).build();
    }

    @Bean
    public RootObjectsModel beanRootObjectsModel(RootStructObjectFactory rootStructObjectFactory) {
        return RootObjectsModel.builder().rootStructObjectFactory(rootStructObjectFactory).build();
    }
    ...
    public SocketRunnableCtrlModel beanSocketRunnableCtrlModel(
            ...
            RootStructObjectFactory rootStructObjectFactory, RootObjectsModel rootObjectsModel) {
        return SocketRunnableCtrlModel.builder().socketRunnableCtrlStructObjectFactory(
                socketRunnableCtrlStructObjectFactory).rootStructObjectFactory(
                        rootStructObjectFactory).rootObjectsModel(rootObjectsModel).build();
    }
