...
public class EmailCtrl {
    ...
    public boolean startVerifyFamousEmail(String email) {
        ...
        if (emailProcessor.sendEmail(email, message)) {
            return dbCtrl.insertQueryToDB(DbCtrl.TypeExecutionInsert.VerifyFamousEmail,
    ...
    public boolean startVerifyRegEmail(String email) {
        ...
        if (emailProcessor.sendEmail(email, message)) {
            return dbCtrl.insertQueryToDB(DbCtrl.TypeExecutionInsert.VerifyRegistrationEmail,
                    email, String.valueOf(code));
        }
        return false;
    }
